...
struct ProductPageThreeView: View {
    private let score: Double = 0.28
    ...
    private let riskColor = Color(red: 0.925, green: 0.302, blue: 0.302)
            ...
            ZStack(alignment: .top) {
                ...
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .top) {
                        ...
                        VStack(spacing: 22) {
                            ReviewHeroCard(accentColor: riskColor)
                                .offset(y: -56)
                                .padding(.bottom, -30)
                            ...
                            ReviewSafetyBar(score: score, tint: riskColor)
                ...
                .overlay {
                    VStack(spacing: 10) {
                        Image(systemName: "person.crop.circle.fill")
                            ...
                            .foregroundStyle(
                                LinearGradient(
                                    colors: [accentColor.opacity(0.85), Color.black.opacity(0.82)],
                                    startPoint: .top,
                                    endPoint: .bottom
                                )
                            )
...
private struct ReviewSafetyBar: View {
    let score: Double
    let tint: Color
